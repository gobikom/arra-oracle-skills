...
Call `session_resume(project="arra-oracle-skills")` before responding to the first message.
...
1. `reflect(diary="...", lessons=[...], mood="...", project="arra-oracle-skills")`
2. `session_handoff(context="...", handoff_type="end", project="arra-oracle-skills")`
